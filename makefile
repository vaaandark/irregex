...
all: $(OBJECTS) $(BUILDDIR)/main.o $(BUILDDIR)/re2tree.o $(BUILDDIR)/re2graph.o
...
.PHONY: clean
clean:
	-rm -rf $(OBJECTS) $(BUILDDIR)re2graph.o $(BUILDDIR)/re2tree.o $(BUILDDIR)/main.o $(BUILDDIR)/irregex $(BUILDDIR)/re2graph $(BUILDDIR)/re2tree
